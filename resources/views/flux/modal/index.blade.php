...
<ui-modal {{ $attributes }} data-flux-modal>
    ...
    >
        ...
        <?php if ($closable): ?>
            <div class="absolute top-0 mt-4 end-0 me-4">
                <flux:modal.close>
                    <flux:button variant="ghost" icon="x-mark" size="sm" alt="Close modal" class="text-zinc-400! hover:text-zinc-800! dark:text-zinc-500! dark:hover:text-white! cursor-pointer"></flux:button>
                </flux:modal.close>
            </div>
        <?php endif; ?>
    </dialog>
