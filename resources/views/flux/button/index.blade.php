...
$classes = Flux::classes()
    ...
    ->add(match ($size) { // Size...
        '3xl' => 'h-20 text-xl rounded-lg' . ' ' . ($square ? 'w-20' : 'px-12'),
        '2xl' => 'h-16 text-lg rounded-lg' . ' ' . ($square ? 'w-16' : 'px-7'),
        'xl' => 'h-14 text-md rounded-lg' . ' ' . ($square ? 'w-14' : 'px-6'),
        'lg' => 'h-12 text-md rounded-lg' . ' ' . ($square ? 'w-12' : 'px-5'),
    ...
    ->add($inset ? match ($size) { // Inset...
        '2xl' => $square
            ? Flux::applyInset($inset, top: '-mt-14.5', right: '-me-14.5', bottom: '-mb-14.5', left: '-ms-14.5')
            : Flux::applyInset($inset, top: '-mt-14.5', right: '-me-7', bottom: '-mb-13.5', left: '-ms-7'),
        'xl' => $square
            ? Flux::applyInset($inset, top: '-mt-6.5', right: '-me-6.5', bottom: '-mb-6.5', left: '-ms-6.5')
            : Flux::applyInset($inset, top: '-mt-6.5', right: '-me-6', bottom: '-mb-9', left: '-ms-6'),
        'lg' => $square
            ? Flux::applyInset($inset, top: '-mt-4.5', right: '-me-4.5', bottom: '-mb-4.5', left: '-ms-4.5')
            : Flux::applyInset($inset, top: '-mt-4.5', right: '-me-5', bottom: '-mb-5.5', left: '-ms-5'),
        'base' => $square
    ...
    ->add($variant === 'primary' ? match ($color) {
        ...
        'green' => '[--color-accent:var(--color-primary-600)] [--color-accent-content:var(--color-primary-600)] [--color-accent-foreground:var(--color-white)] dark:[--color-accent:var(--color-primary-600)] dark:[--color-accent-content:var(--color-primary-400)] dark:[--color-accent-foreground:var(--color-white)]',
