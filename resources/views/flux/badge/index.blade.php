...
$classes = Flux::classes()
    ...
    ->add($variant === 'solid' ? match ($color) {
        ...
        'green' => 'text-white dark:text-white bg-primary-500 dark:bg-primary-600 [&:is(button)]:hover:bg-primary-600 dark:[button]:hover:bg-primary-500',
        ...
        'green' => 'text-primary-800 [&_button]:text-primary-800! dark:text-primary-200 dark:[&_button]:text-primary-200! bg-primary-400/20 dark:bg-primary-400/40 [&:is(button)]:hover:bg-primary-400/30 dark:[button]:hover:bg-primary-400/50',
