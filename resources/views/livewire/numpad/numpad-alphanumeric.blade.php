<div @class([
    ...
    addLetter(letter) {
        ...
        this.value = letter + this.getCurrentDate();
        $dispatch('speak', { text: letter });
    },
    addNumber(number) {
        if (this.disabled) return;
    ...
    @if (env('BARCODE_SCANNER', true))
        <div class="flex gap-2 mb-3">
            <button @click="startScan()" :disabled="disabled || scanning"
                ...
                <span x-text="scanning ? 'Menunggu scan...' : 'Scan Barcode'"></span>
            </button>
    ...
    <div class="grid grid-cols-3 gap-2 mx-auto">
        {{-- Row 0: A B D --}}
        <flux:button @click="addLetter('A')" ::disabled="disabled" variant="outline" size="2xl"
        ...
        <flux:button @click="addLetter('B')" ::disabled="disabled" variant="outline" size="2xl"
            class="w-full !text-3xl font-semibold cursor-pointer active:bg-primary-700 active:text-secondary-300 active:border-secondary-300 hover:!bg-primary-700 hover:text-secondary-300 hover:!border-secondary-300">
            B
        </flux:button>
        <flux:button @click="addLetter('D')" ::disabled="disabled" variant="outline" size="2xl"
            class="w-full !text-3xl font-semibold cursor-pointer active:bg-primary-700 active:text-secondary-300 active:border-secondary-300 hover:!bg-primary-700 hover:text-secondary-300 hover:!border-secondary-300">
            D
        </flux:button>
